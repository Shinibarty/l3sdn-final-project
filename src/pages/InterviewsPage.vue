<template>
  <div class="interviews-page">
    <q-page class="q-pa-md">
      ...
      <div
        v-if="
          entretiensEnAttenteInterviewer.length === 0 &&
          entretiensCompletesInterviewer.length === 0 &&
          entretiensEnAttenteInterviewee.length === 0 &&
          entretiensCompletesInterviewee.length === 0
        "
      ...
      <q-tab-panels v-model="selectedTab">
        ...
        <q-tab-panel name="interviewer">
          ...
          <div>
            ...
            <q-card
              v-for="entretien in entretiensEnAttenteInterviewer"
              :key="entretien.id"
            ...
            >
              <q-card-section>
                <div class="row">
                  ...
                  <div v-if="isManagerOrRH" class="col">
                    <q-btn color="primary" label="Détails" @click="openDetails(entretien)" />
                  </div>
                </div>
            ...
            <h3 v-if="entretiensCompletesInterviewer.length > 0" class="text-h6 q-mt-md">
              Complétés
            </h3>
            <q-card
              v-for="entretien in entretiensCompletesInterviewer"
              :key="entretien.id"
        ...
        <q-tab-panel name="interviewee">
          ...
          <div>
            ...
            <q-card
              v-for="entretien in entretiensEnAttenteInterviewee"
              :key="entretien.id"
              class="q-mb-md bg-blue-grey-3"
            >
              <q-card-section>
            ...
            <!-- Entretiens complétés-->
            <h3 v-if="entretiensCompletesInterviewee.length > 0" class="text-h6 q-mt-md">
              Complétés
            </h3>
            <q-card
              v-for="entretien in entretiensCompletesInterviewee"
              :key="entretien.id"
              class="q-mb-md bg-light-green-5"
            >
              <q-card-section>
